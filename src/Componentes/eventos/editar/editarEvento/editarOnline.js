...
export default class EditaOnline extends React.Component{
  ...
  async editarEvento(event){
    event.preventDefault()
    const url = "http://localhost/testes/atualizarevento.php"
          ...
          <Form.Row>
            ...
            <Col sm={12} md={6} lg={4}>
              <Form.Group>
                ...
                <Form.Control type="number" name="telefone" value={this.state.telefone} onChange={this.alterapadrao}/>
              </Form.Group>
            ...
            <Col sm={12} md={12} lg={4}>
              <Form.Group>
                <Form.Label >Link do evento : </Form.Label>
                  <Form.Control type="url" name="lin"  value={this.state.link} onChange={this.alterapadrao}/>
              </Form.Group>  
            </Col>
          </Form.Row>
