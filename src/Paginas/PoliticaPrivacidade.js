        ...
        return(
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><i>Telefone</i></li>
                    <li><i>E-mail</i></li>
                    <li><i>Bairro, cidade, estado</i></li>
                    <li><i>Formação educacional</i></li>
                ...
                <ul>
                    ...
                    <li><i>Formulário de denúncia</i></li>
                </ul><br />

                <h3>2.1. Consentimento</h3><br />

                <p>É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza o <i>Squad 8</i> a tratar seus dados.<br />
                ...
                O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé do <i>Squad 8</i> para com seus usuários/clientes, seguindo as regulações legislativas pertinentes.<br />
                Ao utilizar os serviços do <i>Squad 8</i> e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los.<br />
                A qualquer tempo e sem nenhum custo, você poderá revogar seu consentimento.<br />
                É importante destacar que a revogação do consentimento para o tratamento dos dados pode implicar a impossibilidade da performance adequada de alguma funcionalidade do site que dependa da operação. Tais consequências serão informadas previamente.</p><br />
                ...
                <h2>5. Como e por quanto tempo seus dados serão armazenados?</h2><br />
                ...
                <h2>7. Com quem seus dados podem ser compartilhados?</h2><br />

                <p>Tendo em vista a preservação de sua privacidade, o <i>Squad 8</i> não compartilhará seus dados pessoais com nenhum terceiro não autorizado.<br /> 
                Seus dados poderão ser compartilhados com nossos parceiros comerciais: <i>a definir</i>.<br />
                ...
                <h3>7.1. Transferência internacional de dados</h3><br />

                <p>Alguns dos terceiros com quem compartilhamos seus dados podem ser localizados ou ou possuir instalações localizadas em países estrangeiros.<br /> 
                Nessas condições, de toda forma, seus dados pessoais estarão sujeitos à Lei Geral de Proteção de Dados e às demais legislações brasileiras de proteção de dados.<br />
                Nesse sentido, o <i>Squad 8</i> se compromete a sempre adotar eficientes padrões de segurança cibernética e de proteção de dados, nos melhores esforços de garantir e cumprir as exigências legislativas.
                Ao concordar com essa Política de Privacidade, você concorda com esse compartilhamento, que se dará conforme as finalidades descritas no presente instrumento.</p><br />



                <h2>8. Cookies ou dados de navegação</h2><br />
                <p>O <i>Squad 8</i> <b>atualmente não faz uso de Cookies</b>, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso.<br />
                Ao acessar nosso site e consentir com o uso de Cookies, você manifesta conhecer e aceitar a utilização de um sistema de coleta de dados de navegação com o uso de Cookies em seu dispositivo.</p>

               <p>Você pode, a qualquer tempo e sem nenhum custo, alterar as permissões, bloquear ou recusar os Cookies. Todavia, a revogação do consentimento de determinados Cookies pode inviabilizar o funcionamento correto de alguns recursos da plataforma.<br />
                Para gerenciar os cookies do seu navegador, basta fazê-lo diretamente nas configurações do navegador, na área de gestão de Cookies.</p><br />
                    
                
                
                <h2>9. Alteração desta Política de Privacidade</h2><br />

                <p>A atual versão da Política de Privacidade foi formulada e atualizada pela última vez em: <i>15 de janeiro de 2021</i>.<br />
                ...
                Ao utilizar nossos serviços e fornecer seus dados pessoais após tais modificações, você as consente.</p> <br />



                <h2>10. Responsabilidade</h2><br />

                <p>O <i>Squad 8</i> prevê a responsabilidade dos agentes que atuam nos processos de tratamento de dados, em conformidade com os artigos 42 ao 45 da Lei Geral de Proteção de Dados.<br />
                ...
                <ol>
                    ...
                    <li>II – Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada do <i>Squad 8</i>.
                        Destacamos que em caso de incidentes de segurança que possam gerar risco ou dano relevante para você ou qualquer um de nossos usuários/clientes, comunicaremos aos afetados e a Autoridade Nacional de Proteção de Dados sobre o ocorrido e cumpriremos as providências necessárias.</li>
                    <li>III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços do <i>Squad 8</i>; quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.</li>
                    </ol><br />



                <h2>11. Encarregado de Proteção de Dados</h2><br />

                <p>A <i>Squad 8</i> disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: <i>Email: squad8recode@gmail.com</i>.<br />
